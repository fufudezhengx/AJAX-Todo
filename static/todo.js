...
var todoTemplate = function(todo) {
    ...
    var t = `
        <tr class="todo-cell" data-id="${id}">
            <td><span class="todo-task">${task}</span></td>
            <td><span>${updated_time}</span></td>
            <td><button class="todo-edit button-secondary pure-button" data-id="${id}">编辑</button></td>
            <td><button class="todo-delete button-error pure-button" data-id="${id}">删除</button></td>
        </tr>
    `
    return t
}
...
var todoUpdateFormTemplate = function(todo) {
    var t = `
      <form class="todo-update-form pure-form">
        <fieldset>
